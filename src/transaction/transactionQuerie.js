...
const getTransactionById = 'SELECT * FROM transaction WHERE budget_id = $1';

const updateTransaction ="UPDATE transaction SET transaction_name = $1, amount = $2, date = $3 WHERE budget_id = $4 RETURNING *";
        
const deleteTransactionById = "DELETE FROM transaction WHERE budget_id = $1";
